...
mol = gto.M (atom=xyz, spin=6, charge=3, basis=basis,
           verbose=4, output='05-kremers_dimer_lasscf.log') 
mf = scf.ROHF(mol)
mf.kernel () 
...
molden.from_mo (mol, '05-kremers_dimer_lasscf_avas_guess.molden', mo_coeff, occ=mf.mo_occ)
...
molden.from_mo (mol, '05-kremers_dimer_lasscf_localized_guess.molden', mo_coeff)

las.kernel (mo_coeff)

from mrh.my_pyscf.tools import molden as my_molden
my_molden.from_lasscf (las, '05-kremers_dimer_lasscf.molden')
