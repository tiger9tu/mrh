...
def create_parameter_file_dict(logfile,fragments):
	...
	parameter_file_dict={	#'cholesky_eri':[logfile],
				...
				'Hessian operator 2':flas_files,#[flas_file],
                                #'LASPSCF get_veff_Heff 1':flas_files,#[flas_file],
                                #'LASPSCF get_veff_Heff 2':flas_files,#[flas_file],
                                #'LASPSCF get_veff_Heff 3':flas_files,#[flas_file],     
                                #'LASPSCF get_veff_Heff 4':flas_files,#[flas_file],      
                                #'LASPSCF get_veff_Heff 5':flas_files,#[flas_file],
				...
				'Hessian operator total':flas_files,#[flas_file],
                                'LASPSCF wrap-up':flas_files, 
                                'canonicalization':flas_files,
				#'update_h2eff_sub':flas_files,#[flas_file],
